...
//   @override
//   Future<Either<Failure, List<SongEntity>>> toggleFavoriteSong(
//       String userId, String songId) async {
//     try {
//       // Toggle the favorite status and get the updated list of favorite songs
//       final songModels =
//           await favSongDatabase.toggleFavoriteSong(userId, songId);

//       // Convert the SongModel to SongEntity
//       final favSongEntities = songModels.map((songModel) {
//         return SongEntity(
//           songId: songModel.songId,
//           title: songModel.title,
//           artist: songModel.artist,
...
//       return right(favSongEntities);
//     } catch (e) {
//       return left(Failure('Failed to toggle favorite song: $e'));
//     }
//   }
// }
